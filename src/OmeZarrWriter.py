...
class OmeZarrWriter(OmeWriter):
    def __init__(self, zarr_version=2, ome_version='0.4'):
        super().__init__()
    ...
    def write(self, filename, source, **kwargs):
        ...
        write_plate_metadata(zarr_root, row_names, col_names, well_paths, acquisitions=acquisitions, fmt=self.ome_format)
